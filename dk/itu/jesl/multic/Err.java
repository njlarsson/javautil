...
public class Err {
   public static class FormatException extends RuntimeException {
      private int page = 0, problem = 0;
      private String spec = null, sect = null;
      ...
      FormatException setProblem(int problem) { this.problem = problem; return this; }
	 ...
	 if (problem != 0) { b.append(" in problem ").append(problem); }
